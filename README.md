...
- Дополнительные способы экспорта плейлистов
  - Экспорт в формате AIMP (M3U8) с относительными путями
    - Копирование всех треков в подпапку с оригинальными именами
    - Создание плейлиста M3U8 с относительными путями для переносимости
- Демо-плеер (MVP)
...
- Расширенные возможности управления треками
  - Отображение общей длительности треков в плейлисте (в заголовке, формат "2:34:15")
  - Отображение длительности каждого трека в отдельной колонке (формат "3:45")
